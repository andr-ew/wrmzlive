...
curveDefs[3] = {
    ...
    getPoint: (t, optionalTarget) => {
        ...
        return point.set(x, y, z).multiplyScalar(160);
    },
};
...
curveDefs[4] = {
    ...
    getPoint: (t, optionalTarget) => {
        ...
        return point.set(x, y, z).multiplyScalar(50);
    },
};
//TODO: large version of 4 (trifoil)
...
curveDefs[6] = {
    ...
    getPoint: (t, optionalTarget) => {
        ...
        return point.set(x, y, z).multiplyScalar(55);
    },
};
